...
<head>
    ...
    <link rel="stylesheet" href="https://use.typekit.net/upk5rci.css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <?php 
    // Google Fontin "optimaalinen" asennus. Vaihda vain linkki tähän alle:
    $googleFontLink = "https://fonts.googleapis.com/css2?family=Lexend:wght@400;700;800;900&display=swap";
    ?>
